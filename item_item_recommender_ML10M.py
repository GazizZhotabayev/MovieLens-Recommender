def compute_similarity_scores(folder, output):
    '''
        With this script we will read in the MovieLens 10M ratings dataset
        and, using PySpark, produce a similarity table for every single pair of movies
        that were watched by the same user
    '''
